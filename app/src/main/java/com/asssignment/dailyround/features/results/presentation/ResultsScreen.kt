...
fun ResultsScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            AppTextBodyMedium(
                modifier = Modifier.padding(top = 20.dp).padding(horizontal = 40.dp),
            ...
            Row(Modifier.padding(vertical = 20.dp)) {
                SummaryComponent(modifier = Modifier.weight(1f), title = stringResource(R.string.correct_answers), value = "$correctAns/$totalQuestions")
                SummaryComponent(modifier = Modifier.weight(1f), title = "Highest Streak", value = "$highestStreak")
            }
