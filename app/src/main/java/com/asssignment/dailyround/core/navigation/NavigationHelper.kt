...
sealed class NavigationHelper(open val routeName: String) {
    ...
    data object ResultsRoute : NavigationHelper("results_screen") {
        fun createRoute(highestStreak: Int, correctAns: Int, totalQuestions: Int): String {
            return "results_screen?highestStreak=$highestStreak&correctAns=$correctAns&totalQuestions=$totalQuestions"
        }
    }}
